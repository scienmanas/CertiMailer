...
export function SideBar(): JSX.Element {
  ...
  const items = [
    { Icon: FaHome, label: "Home", link: "/console" },
    {
      Icon: PiCertificateDuotone,
      label: "Generate",
      link: "/console/generate",
    },
    { Icon: FiActivity, label: "Activity", link: "/console/activity" },
    { Icon: SiFuturelearn, label: "Learn", link: "/console/learn" },
    { Icon: VscIssues, label: "Issues", link: "/console/issues" },
  ];
